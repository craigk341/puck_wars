...
POST_GAME_TIME = 90.0                   -- How long should we let people look at the scoreboard before closing the server automatically?
TREE_REGROW_TIME = 60.0                 -- How long should it take individual trees to respawn after being cut down/destroyed?

GOLD_PER_TICK = 5                       -- How much gold should players get per tick?
GOLD_TICK_TIME = .20                      -- How long should we wait in seconds between gold ticks?
...
FORCE_PICKED_HERO = npc_dota_hero_puck  -- What hero should we force all players to spawn as? (e.g. "npc_dota_hero_axe").  Use nil to allow players to pick their own hero.
...
TEAM_COLORS[DOTA_TEAM_GOODGUYS] = { 0, 153, 255 }  --    Light Blue
TEAM_COLORS[DOTA_TEAM_BADGUYS]  = { 241, 73, 200 }   --    Pink
...
CUSTOM_TEAM_PLAYER_COUNT = {3}           -- If we're not automatically setting the number of players per team, use this table
